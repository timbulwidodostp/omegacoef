{smcl}
{* *! version 1.1  September 8, 2021}{...}
{cmd:help omegacoef}
{hline}
{viewerjumpto "Syntax" "omegacoef##syntax"}{...}
{viewerjumpto "Options table" "omegacoef##options_table"}{...}
{viewerjumpto "Description" "omegacoef##description"}{...}
{viewerjumpto "Options" "omegacoef##options"}{...}
{viewerjumpto "Examples" "omegacoef##examples"}{...}
{viewerjumpto "Stored results" "omegacoef##stored_results"}{...}
{viewerjumpto "References" "omegacoef##references"}{...}

{title:Title}

{p2colset 4 10 13 2}{...}
{p2col:{bf: omegacoef}}{hline 2} Calculates McDonald's omega, also known as
...
{p 8 15 2}
{cmd:omegacoef} {it:varlist} [, {it:options}]
...
{pstd}
{cmd:omegacoef} calculates the scale reliability coefficient known as McDonald's
...
alpha are met. {cmd:omegacoef} is based on loadings from confirmatory factor
...
{phang2}{stata "omegacoef bg2cost1-bg2cost6"}{p_end}


{pstd}Variables with values that are missing at random{p_end}
{phang2}{stata "webuse cfa_missing"}{p_end}
{phang2}Without using the variables with missingness: {stata "omegacoef test1-test4"}{p_end}
{phang2}Using all information: {stata "omegacoef test1-test4, usem"}{p_end}
...
{pstd}
{cmd:omegacoef} saves the following in {cmd:r()}: 
